            ...
            {articles.map((article, i) => (
              <FadeIn key={i} delay={i * 100} className="h-full">
                <a
                  ...
                  className="group flex flex-col h-full relative rounded-2xl border border-zinc-800 bg-zinc-900/60 overflow-hidden hover:border-zinc-700 transition-colors"
                >
                  <GlowingEffect
                    spread={35}
                    glow={true}
                  ...
                  <div className="relative z-10 h-40 overflow-hidden shrink-0">
                    {article.thumbnail ? (
                      <Image
